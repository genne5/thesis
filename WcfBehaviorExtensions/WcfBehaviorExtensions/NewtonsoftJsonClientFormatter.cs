    ...
    class NewtonsoftJsonClientFormatter : IClientMessageFormatter
    {
        ...
        public object DeserializeReply(Message message, object[] parameters)
        {
            ...
            using (var ms = new MemoryStream(body))
            {
                ...
                {
                    var returnType = this.operation.Messages[1].Body.ReturnValue.Type;
        ...
        public Message SerializeRequest(MessageVersion messageVersion, object[] parameters)
        {
            ...
            var requestMessage = Message.CreateMessage(messageVersion, operation.Messages[0].Action, new RawBodyWriter(body));
            ...
            var reqProp = new HttpRequestMessageProperty();
